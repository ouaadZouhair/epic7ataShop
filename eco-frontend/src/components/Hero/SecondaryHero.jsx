...
const SecondaryHero = () => {
  return (
    <div className="flex flex-wrap lg:flex-nowrap justify-center lg:justify-between items-center gap-6 w-full">
      ...
      <div className="relative bg-gradient-to-r from-amber-400 to-amber-300 w-[95%] md:w-[350px] lg:w-1/3 h-64 rounded-2xl shadow-md text-white hover:scale-105 hover:shadow-lg duration-300">
      ...
      <div className=" relative bg-gradient-to-r from-blue-600 to-blue-500 w-[95%] md:w-[350px] lg:w-1/3 h-64 rounded-2xl shadow-md text-white hover:scale-105 hover:shadow-lg duration-300">
        <div className='absolute flex flex-col justify-center items-start gap-2 top-5 p-4 z-10'>
      ...
      <div className="relative bg-gradient-to-r from-red-600 to-red-500 w-[93%] lg:w-1/3 h-64 md:h-[300px] lg:h-64 rounded-2xl shadow-md text-white hover:scale-105 hover:shadow-lg duration-300">
        ...
        <img src={Cap} alt="hoodie" className='absolute w-[280px] md:w-[450px] lg:w-[250px] z-0 -right-2 -top-7 md:-top-20 lg:-top-3 rotate-12' />
      </div>

  ...
  return (
    <nav className="flex justify-around md:justify-center md:gap-5 items-center px-7 md:px-0 w-full py-3 z-50">
      ...
      <div className="flex  justify-around gap-3 w-[500px]">
        ...
        {!user ? (
          <div className="hidden lg:flex lg:justify-between gap-5">
          ...
          <div className="relative w-28 flex justify-between items-center">
            <button className="group" onClick={toggleProfileMenu}><FaUserAlt className="text-2xl group-hover:text-red-600 group-hover:scale-110 duration-100" /></button>
            {isProfileMenuVisible && (
              <div className="absolute top-16 right-0 z-50 bg-white shadow-lg rounded-md w-48 overflow-hidden">
                <p className="text-lg font-semibold px-4"> {user.fullName}</p>
                <p className="text-sm text-gray-500 px-4">{user.email}</p>
                <button
                  className="text-white font-semibold mt-2 w-full py-2 bg-red-600 hover:bg-red-700 duration-100"
                  onClick={logout}
                >
                  Logout
                </button>
            ...
            <button className="group"><IoIosHeart className="text-3xl group-hover:text-red-600 group-hover:scale-110 duration-100 " /></button>
          </div>
        )}

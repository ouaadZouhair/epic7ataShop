...
function EditConfi({ onCancel, onEdit, title }) {
    return (
            ...
            <div className="absolute top-5 bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
                <div className='flex flex-col justify-center items-center gap-2'>
                    ...
                    <h3 className="text-xl text-center font-semibold mb-4">
                        Are you sure you want to edit this <br /> "{title}"?
                    </h3>
                </div>
                <div className="flex justify-end gap-4">
                    ...
                    <button
                        onClick={onEdit}
                        className="px-4 py-2 bg-green-500 hover:bg-green-600 hover:scale-105 hover:shadow-md duration-150 text-white rounded-lg"
                    >
                        Edite
                    </button>
                </div>

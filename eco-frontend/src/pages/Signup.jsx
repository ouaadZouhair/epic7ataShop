  ...
  return (
    <div style={{ backgroundImage: `url(${bg1})` }} className="bg-cover bg-top h-screen w-full flex items-center justify-end">
      ...
      <div className="bg-white rounded-bl-full shadow-lg p-10 w-[700px] h-full flex flex-col justify-start items-end pr-28">
        ...
        <form className="w-[300px] flex flex-col justify-center items-center gap-1 " onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="relative w-full">
            ...
            <button type="button" onClick={() => setShowConfirmPassword(!showConfirmPassword)} className="absolute right-3 top-11 text-xl text-gray-400 hover:text-blue-500 duration-100">
          ...
          <button
            type="submit"
            className="w-full bg-blue-700 text-white py-2 px-4 rounded-lg text-lg font-semibold hover:bg-blue-600 transition mt-3 disabled:opacity-50"
            disabled={loading}
          >
